...
module.exports = async (req, res, next) => {
  ...
  if (!authTokenRaw) return next(httpErrors(400, 'token missing in header'))
  ...
  try {
    ...
    if (decoded) {
      ...
      const userData = { ...user.toObject(), password: undefined, verificationToken: undefined, otp: undefined }
